    ...
    return (
        <div className='max-w-[1240px] mx-auto p-4 '>
            <div className='flex justify-center sm:justify-between items-center relative'>
                ...
                <button className='absolute right-0 top-2 rounded-md px-5 py-1.5 border border-white text-white bg-[#0969DA] sm:static'>
                    Sign in
                </button>
                 <button className=' hidden sm:block rounded-md px-5 py-1.5  text-white  '>
                    Sign Up
                </button>
                </div>
